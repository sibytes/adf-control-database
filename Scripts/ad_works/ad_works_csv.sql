...
DECLARE @project varchar(250) = 'ad_works_csv'
...
VALUES
  (@ibi, @project, 'adventure works  - adventure works csv ingest', 1, 'op_sqls-to-landing_blbs_csv', 0, 'load_base_ad_works');
...
VALUES
(@ibi, @project, 'Landing AD Works', 'landing', '/mnt', 'landing', '/data/ad_works/csv/{{table}}/{{from_timeslice}}', '{{table}}-{{from_timeslice}}', 'sa_test', 'yyyyMMdd', 'yyyyMMdd');
