...
DECLARE @project varchar(250) = 'ad_works_lt_csv'
...
VALUES
  (@ibi, @project, 'adventure works lightweight  - adventure works LT csv ingest', 1, 'op_sqls-to-landing_blbs_csv', 0, 'load_base_ad_works_lt');
...
VALUES
(@ibi, @project, 'Landing AD Works LT', 'landing', '/mnt', 'landing', '/data/ad_works_lt/csv/{{table}}/{{from_timeslice}}', '{{table}}-{{from_timeslice}}', 'sa_test', 'yyyyMMdd', 'yyyyMMdd');
