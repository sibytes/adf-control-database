...
DECLARE @project varchar(250) = 'contoso_retail_dw_json'
...
VALUES
  (@ibi, @project, 'contoso retail dw - contoso retail dw json ingest', 1, 'op_sqls-to-landing_blbs_json', 0, 'ingest_contoso_retail_dw');
...
VALUES
(@ibi, @project, 'Landing Contoso Retail DW', 'landing', '/mnt', 'landing', '/data/contoso_retail_dw/json/{{table}}/{{from_timeslice}}', '{{table}}-{{from_timeslice}}', 'sa_test', 'yyyyMMdd', 'yyyyMMdd');
