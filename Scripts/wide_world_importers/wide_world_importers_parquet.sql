...
DECLARE @project varchar(250) = 'wide_world_importers_parquet'
...
VALUES
  (@ibi, @project, 'wide world importers - parquet ingest', 1, 'op_sqls-to-landing_blbs_parquet', 0, 'ingest_wide_world_importers');
...
VALUES
(@ibi, @project, 'landing', 'Landing WWI', '/mnt', 'landing', '/data/wide_world_importers/parquet/{{table}}/{{from_timeslice}}', '{{table}}-{{from_timeslice}}', 'sa_test', 'yyyyMMdd', 'yyyyMMdd');
