...
DECLARE @project varchar(250) = 'wide_world_importers_csv'
...
VALUES
  (@ibi, @project, 'wide world importers - csv ingest', 1, 'op_sqls-to-landing_blbs_csv', 0, 'ingest_wide_world_importers');
...
VALUES
(@ibi, @project, 'landing', 'Landing WWI', '/mnt', 'landing', '/data/wide_world_importers/csv/{{table}}/{{from_timeslice}}', '{{table}}-{{from_timeslice}}', 'sa_test', 'yyyyMMdd', 'yyyyMMdd');
