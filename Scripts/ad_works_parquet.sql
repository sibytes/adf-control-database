...
VALUES
  (@ibi, @project, 'adventure works lightweight  - adventure works parquet ingest', 1);
...
VALUES
(@ibi, @project, 'Landing AD Works', 'landing', '/mnt', 'landing', '/data/ad_works/parquet/{{table}}/{{path_date_format}}', '{{table}}-{{filename_date_format}}', 'sa_test', 'yyyyMMdd', 'yyyyMMdd');
