...
DECLARE @project varchar(250) = 'ad_works_dw_json'
...
VALUES
  (@ibi, @project, 'adventure works dw  - adventure works dw json ingest', 1, 'op_sqls-to-landing_blbs_json', 0, 'load_base_ad_works_dw');
